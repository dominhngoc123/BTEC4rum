                ...
                <form action="" method="post">
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            <select class="form-control form-control-sm post-inp-color" required>
                        ...
                        <div class="col-md-4 mb-3">
                            <select class="form-control form-control-sm post-inp-color" required>
                                <option selected disabled value="">Select Thread...</option>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <textarea class="form-control auto-textarea post-inp-color" placeholder="Enter title here..."
